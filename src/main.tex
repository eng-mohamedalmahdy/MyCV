...
\begin{document}
    ...
    \begin{quote}
        ...
        My primary are in \textbf{Native Android}, \textbf{iOS} \& \textbf{Kotlin Multiplatform} frameworks.
...
%        \divider
    ...
    \begin{paracol}{2}
        ...
        \begin{multicols}{2}
            ...
            \cvevent {\faTrello  \href{https://trello.com/b/pkZlgQVu/my-readings-board}{My readings book list: \textbf{\textcolor{TertiaryColor}{HERE}}}}{}{}{}
    ...
    \begin{paracol}{1}
        ...
        \cvevent{\color{AndroidGreenColor}\textbf{Masarify}}
        ...
        \cvevent{\color{AndroidGreenColor}\textbf{Islami 180}}
        {\cvrepo{\color{AndroidGreenColor}|\faGooglePlay\faAndroid}
        ...
        \cvevent{\color{AndroidGreenColor}\textbf{Violet}}
        ...
        \cvevent{\color{SwiftOrangeColor}\textbf{Pet Matrices}}
        {\cvrepo{\color{SwiftOrangeColor}|\faLock\faApple}
        {}}{}{}
        \begin{itemize}
        ...
        \end{itemize}
        \divider
        \cvevent{\color{AndroidGreenColor}\textbf{Zakerly}}
        ...
        \cvevent{\color{AndroidGreenColor}\textbf{MusicHub}}
        {\cvrepo{\color{AndroidGreenColor}|\faGithub\faAndroid}
        ...
        \cvevent{\color{SwiftOrangeColor}\textbf{Memorise}}
        {\cvrepo{\color{SwiftOrangeColor}|\faGithub \faApple}
