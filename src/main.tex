...
\begin{itemize}
\item Developing the \href{https://play.google.com/store/apps/details?id=za.co.vitalitydrive.tawuniya}{\textbf{Tawuniya Drive App}} to enhance user experience in mobility ecosystem and telematics services.
\item Collaborated on the \textbf{Tawuniya Drive SDK}, a Kotlin Multiplatform (KMP) SDK encapsulating domain \& data layers to \linebreak ensure consistency, scalability, and developer productivity across shared modules.
\end{itemize}
\divider
...
\begin{itemize}
\item \textbf{Pet Needs delivery e-commerce platform} serving multiple user roles: store owners, customers, and delivery personnel, with feature-based modular architecture.
\item Implements \textbf{Kotlin Multiplatform modules} with \textbf{Clean Architecture} principles.
\item \textbf{Tech Stack}: \textbf{Jetpack Compose - MVVM - Koin DI - Ktor Client - Modularization - Arrow-kt - Paging 3 - Coil 3}
\end{itemize}
\divider
...
\begin{itemize}
\item \textbf{Veterinary clinic and pet care platform} with dual applications: customer-facing app for booking services, shopping, and pet management, plus a driver/delivery app for service providers.
\item Leveraging Kotlin Multiplatform (KMP) for seamless cross-platform development (Android \& iOS).
\item \textbf{Tech Stack}: \textbf{MVVM - Compose Multiplatform - Koin DI - Ktor - Navigation Compose - KotlinX Serialization - Coil 3 - Moyasar Payment SDK - MapLibre Maps - Moko Resources}
\end{itemize}
\divider
