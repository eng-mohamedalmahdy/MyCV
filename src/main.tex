...
% \end{tikzpicture}
        ...
        \cvevent{Mid Level Android developer  }{| \textbf{DTag}}{04/2023 -- Now}{Cairo, Egypt}
        \divider

        \cvevent{JR. Software developer  }{| \textbf{Virtual Worker Now}}{12/2021 -- 5/2022}{Cairo, Egypt}
        \begin{itemize}
        ...
        \end{itemize}
        \divider
        \cvevent{JR. Android developer }{| \textbf{ElMnassa Innovation}}{6/2020 -- 12/2020}{Cairo, Egypt}
        \divider
        ...
        \begin{multicols}{2}
            ...
            \cvevent
            {\faAndroid  Kotlin boot camp}{| \textbf{Udacity}}{}{}
            \divider

            \cvevent
            {\faAndroid Android Dev in Java}{| \textbf{Udacity}}{}{}
            \divider
            ...
            \cvevent {\faApple iOS Boot Camp}{| \textbf{Tuwaiq ACAD}}{}{}
